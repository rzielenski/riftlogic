...
const KIT_OWN_GRANTS = new Set(["Zed.R","Pantheon.E","Naafiri.W","Olaf.R","Fiora.W","Lissandra.R","Gwen.W"]);   // Gwen.W (P6 F4): untargetable only to enemies outside the mist (CHAMP_MECH.Gwen)
